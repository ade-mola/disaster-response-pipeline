...
INPUTS - 
    ...
    3) SQLite database (DisasterResponse.db)
"""
...
def load_data(messages_filepath, categories_filepath):
    ...
    """ A function that loads inputs, two CSV files\
        ...
        OUTPUT - 
        df: Dataframe obtained from merging the two input data. 
    """
...
def clean_data(df):
    ...
    """ A function that cleans the merged dataframe for use.
    
        INPUT - 
        df: Merged dataframe returned from load_data() function
        
        OUTPUT - 
        df: Cleaned dataframe version to be used
    """
    ...
    # df['related'] contains three distinct values
...
def save_data(df, database_filename):
    ...
    """ Saves cleaned data to an SQL database
        ...
        INPUT - 
        df: Cleaned dataframe returned from clean_data() function
